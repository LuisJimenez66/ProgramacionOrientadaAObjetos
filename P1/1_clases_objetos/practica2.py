...
class Coches:
    ...
    def acelerar(self,incremento):
        self.velocidad.velocidad+incremento
        return self.velocidad    
    def frenar(self,decremento):
        self.velocidad.velocidad-decremento
        return self.velocidad
...
print(f"Los valores del objeto 2 son: {coche2.color}, {coche2.marca}, {coche2.frenar(100)}")
'''